...
@Component
public class OAuth2AuthorizationCodeTokenGatewayFilterFactory
		extends AbstractGatewayFilterFactory<OAuth2TokenFilterParams> {

	private final ReactiveOAuth2AuthorizedClientManager authorizationCodeAuthorizedClientManager;

	public OAuth2AuthorizationCodeTokenGatewayFilterFactory(
			ReactiveOAuth2AuthorizedClientManager authorizationCodeAuthorizedClientManager) {
	...
	public GatewayFilter apply(OAuth2TokenFilterParams oAuth2TokenFilterParams) {
		return new OAuth2AuthorizationCodeTokenFilter(authorizationCodeAuthorizedClientManager,
